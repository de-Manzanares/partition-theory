...
By (1.2.33),
\[
    (a;q)_{k+(n-k)} = (a;q)_k(aq^k;q)_{n-k} \iff (aq^k;q)_{n-k} = \frac{(a;q)_n}{(a;q)_k}.
\]

\subsubsection*{(1.2.36)}
By (1.2.33),
\[
    (a;q)_{2k+n-k}=(a;q)_{2k} (aq^{2k};q)_{n-k} \iff (aq^{2k};q)_{n-k}= \frac{(a;q)_{n+k}}{(a;q)_{2k}}.
\]
Therefore
\[
...
\begin{align*}
    (a^2;q^2)_n &= (1-a^2)(1-a^2 q^2)\cdots(1-a^2 q^{2n-2})\\
